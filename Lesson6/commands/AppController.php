<?php
//контроллер для создания первоначальных данных работы приложения.
    ...
    public function actionActivities()
    {
        ...
        foreach ($titles as $title) {
            ...
            $activity = new Activity([
                ...
                'user_id_fd' => random_int(1, 3),
                'date_start_fd' => $activityDate,
                'date_end_fd' => $activityDate,
                'blocked_fd' => random_int(0, 1),
                'repeat_fd' => false,
            ]);
            $activity->save();
            $day++;
